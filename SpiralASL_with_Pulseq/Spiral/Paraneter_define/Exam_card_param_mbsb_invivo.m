...
if ~isfield(MrProt.sliceGroupList(1),'shiftflag')
...
MrProt.sliceSeries.aFront.thickness = MrProt.sliceGroupList(1).thickness;
...
if MrProt.dim == 3
 ...
 slab_thickness = (MrProt.sliceSeries.size-1)*MrProt.sliceGroupList(1).thickness*MrProt.sliceGroupList(1).distanceFactor + ...
     MrProt.sliceGroupList(1).thickness*MrProt.sliceSeries.size;
 for i = 1:MrProt.sliceSeries.size
     MrProt.sliceGroup(1).pslc(i).SliceShift = -(slab_thickness/2-MrProt.sliceGroupList(1).thickness/2)+ ...
         (i-1)*MrProt.sliceGroupList(1).thickness*(1+MrProt.sliceGroupList(1).distanceFactor) + ...
