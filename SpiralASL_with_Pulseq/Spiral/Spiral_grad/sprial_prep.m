function [spiral,MrProt,SeqLim] = sprial_prep(spiral,MrProt,SeqLim)
...
if lSpiralType > 9
    ...
    if VD < 0.1
        ...
        spiral = VDSpiral(dFOV, dFOV/BaseRes, NCur, nInterleaves, alpha, MaxGradAmp,MaxSlewRate,1,ExtraDelay,spiral);
