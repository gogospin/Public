function [TmpGrad,GradAmp] = DesignSOSPBlips(Separation, spiral )
%DesignSOSPBlips(Separation, Delay_us, Period_us, TotalTime_us,spiral )
...
DesiredMoment = 1000000/(Separation*dGamma/1000000.0);
...
if mod(nSteps,2)==1
    TmpGrad(FHalfnSteps+1)=BlockH*(FHalfnSteps)/GradAmp;
end
% 
